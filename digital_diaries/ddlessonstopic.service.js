...
async function getddLessonsTopics(userParam) {
  try {
    ...
    console.log("State Detail: ", stateDetail, "getddLessonsTopics");
    ...
    console.log("DDLessons: ", lessons, "getddLessonsTopics");
    ...
    console.log("DDTopics: ", lessonTopics, "getddLessonsTopics");
    ...
    console.log("DDProgress: ", lessonProgresses, "getddLessonsTopics");
    ...
    console.log("Final Lessons: ", finallessons, "getddLessonsTopics");

    return finallessons;
  } catch (error) {
    console.log("Error in: ", error, "getddLessonsTopics");
    throw error;
  }
}
  ...
  try {
    ...
    if (
      ...
      if (lessonArray) {
        ...
        console.log("LessonWithTopics: ", lessonWithTopics, "getTopicsForLesson");
        return lessonWithTopics;
      } else {
        return "No lesson details found";
      }
  } catch (error) {
    console.log("Error in: ", error, "getTopicsForLesson");
  }
}
...
function getDDTopicsForDaily(ddTopicArray, tomorrow) {
  try {
    ...
    console.log("Error in: ", error, "getDDTopicsForDaily");
  }
}
...
function getDDTopicsForWeek(ddTopicArray, weekFrom, weekTo) {
  try {
    ...
    console.log("Error in: ", error, "getDDTopicsForWeek");
  }
}
