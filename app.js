...
app.use(
  "/scert_solutions",
  require("./scert_solutions/scertsolutions.controller")
);
...
app.use(
  "/webassessment",
  require("./webassessments/webassessments.controller")
);
app.use("/sparkles", require("./sparkles/sparkle.controller"));
app.use(
  "/digitaldiaries",
  require("./digital_diaries/digitaldiaries.controller")
);

app.use("/assessment", require("./assessments/assessments.controller"));
app.use(
  "/assessmentreport",
  require("./assessments/assessmentreport.controller")
);
